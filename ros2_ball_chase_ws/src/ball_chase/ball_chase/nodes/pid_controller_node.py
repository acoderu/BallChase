    ...
    def _declare_parameters(self):
        self.node.declare_parameters(
            ...
            parameters=[
                ...
                ('lateral_threshold', 0.035),
                ('angular_threshold', 2.5),
                ('angular_at_target_factor', 2.75),
                ...
                ('coordinated_coupling_factor', 0.65),
                ('coordinated_smoothing_factor', 0.55),
                ('coordinated_min_angle_for_reduction', 0.05),
                ('coordinated_zero_angle_threshold', 0.02),
                ('coordinated_max_angle_factor', 0.25),
                ('coordinated_same_sign_scale', 0.55),
