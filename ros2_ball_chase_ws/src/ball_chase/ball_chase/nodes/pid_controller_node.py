    ...
    def _declare_parameters(self):
        self.node.declare_parameters(
            ...
            parameters=[
                ...
                ('angular_threshold', 2.8),
                ('angular_at_target_factor', 2.25),
                ...
                ('strategy_blend_duration', 0.08),
                ('coordinated_movement', True),
                ('filter_buffer_size', 6),
                ('prediction_horizon', 0.17),
                ...
                ('coordinated_coupling_factor', 0.35),
                ('coordinated_smoothing_factor', 0.3),
                ('coordinated_min_angle_for_reduction', 0.06),
                ('coordinated_zero_angle_threshold', 0.02),
                ('coordinated_max_angle_factor', 0.25),
                ('coordinated_same_sign_scale', 0.65),
